...
function reducer(state, action) {
  ...
  if(isActive){
    switch (action.type) {
      ...
      case "withdraw":
        return{ ...state,balance:balance-50};
      case "requestLoan":
        return loan===0?{ ...state,loan:5000,balance:balance+5000}:state;
      case "payLoan":
        return loan!==0?{ ...state,loan:0,balance:balance-5000}:state;;
      case "closeAccount":
        return loan===0&&balance===0?initialState:state;
      default:
